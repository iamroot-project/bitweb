...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitweb-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitweb-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitweb transaction") + "\n" +
              "  bitweb-tx [options] -create [commands]   " + _("Create hex-encoded bitweb transaction") + "\n" +
              "\n";
